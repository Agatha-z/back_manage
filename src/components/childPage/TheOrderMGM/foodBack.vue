    ...
    export default {
        data(){
            return {
                ...
                pageSize:10,//每页显示条数
                data_list:[
                    {   name:'安少爷米线（商之都店）',why:'客户结账后退菜',code:'2333445534',Seat:'PSHJD2',
                        class:'无敌酸辣粉辣死你',foodname:'不是酸辣粉',specifications:'标准',practice:'微辣',
                        refundNum:1,money:23,operation:'马路牙子',approval:'大哥',refundTime:'2018-8-10 23:22:12',
                        pointTime:'2018-12-23 11:12:45'
                    },
                    {   name:'安少爷米线（商之都店）',why:'客户结账后退菜',code:'2333445534',Seat:'PSHJD2',
                        class:'无敌酸辣粉辣死你',foodname:'不是酸辣粉',specifications:'标准',practice:'微辣',
                        refundNum:1,money:23,operation:'马路牙子',approval:'大哥',refundTime:'2018-8-10 23:22:12',
            ...
            ExportData(){
                this.$confirm('此操作将导出全部菜品数据, 是否继续?', '提示', {
                    ...
                    require.ensure([], () => {
                        ...
                        const tHeader = ['机构名称','退菜原因','账单编号','桌位名称','菜品分类','菜品名称','规格','做法','退菜数量','金额','操作人','批准人','退菜时间','点菜时间'];
                        const filterVal = ['name', 'why', 'code', 'Seat', 'class', 'foodname', 'specifications','practice','money','operation','approval','refundTime','pointTime'];
