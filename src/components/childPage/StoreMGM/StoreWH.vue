...
<template>
    <div class="postPre">
        <div class="commonHeader_style">
            ...
            <!--新增仓库-->
            <el-button type="primary" @click="addWarehouse" style="margin-top:20px;">新增仓库<i class="el-icon-plus el-icon-plus-right"></i></el-button>
            <!--数据-->
                    ...
                    <div class="center_box" v-if="show_center" @click.stop>
                        ...
                        <div class="content_scroll">
                            ...
                            <div style="display:flex;justify-content:center;">
                                注：门店仓库即为出品部门，总部统一设置门店仓库（出品部门），每个门店的仓库名称（出品部门）相同。
                            </div>
                        </div>
                        <!-- 底部内容 -->
    ...
    export default {
        data(){
            return{
                ...
                data_list:[ //渲染数据
                    {s_name:'CK02',brand:'门店原材料仓',attribute:'2017-12-17',},
        ...
        methods:{
            ...
            //输入框失去焦点事件
            blur(){
                if( this.title=='新增门店仓库'){//只有在新增门店仓库的前提下失去焦点事件才出发
                    this.isBlur=true;
                }
            },
        },
