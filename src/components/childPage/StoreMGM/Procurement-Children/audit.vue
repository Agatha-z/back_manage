                    ...
                    <table class="table_list" border="0" cellspacing="0">
                        ...
                        <tr v-for="(v,k) in data_list" :key="k">
                            ...
                            <td>
                                ...
                                <el-button type="primary" size="small" icon="el-icon-goods" @click="operation(2,k,v)" v-show="true">审核</el-button>
                            </td>
                        </tr>
                        <!-- 无数据显示 -->
    ...
    export default {
        data(){
            return{
                ...
                data_list:[ //渲染数据
                    {s_name:'18121415450025',brand:'自采',attribute:'安少爷米线（瑶海万达店）',areaName:'总部配送中心',formats:'2018-12-20',user:'3364.50',time:'2018-12-20 11:16:32',},
                ],
            }
        },
        methods:{
