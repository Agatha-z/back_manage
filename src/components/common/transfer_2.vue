<template>
    <div class="transfer">
        ...
        <div class="btns">
            <div style="margin:140px 0 0 0;font-size:18px;font-weight:600;text-align:center">
                <span>加价</span>
        ...
        <div class="right">
            ...
            <div class="footComList">
                <div class="header_tops">
                    ...
                    <div class="tit" style="width:22%">此规格价格</div>
                    &nbsp;
                    <div class="tit" style="width:22%">会员价</div>
                    ...
                    <div v-for="(v,k) in addList" :key="k">
                        <div class="border_bottom">
                            ...
                            <div class="tit" style="width:22%">
                                <el-input-number size="mini" :min="0" style="width:100%" v-model="v.money" @change="index++"></el-input-number>
                            </div>
                            &nbsp;
                            <div class="tit" style="width:22%">
                                <el-input-number size="mini" :min="0" style="width:100%" v-model="v.viPrice" @change="index++"></el-input-number>
                            </div>
                            <div class="tit">
